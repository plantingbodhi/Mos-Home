              ...
              <div className="border-2 border-black rounded-[32px] p-6">
                <div className="space-y-8">
                  <p className="text-lg text-center">
                    Mos isn&apos;t a rigid method — it&apos;s a living system.
                    You can start with Mystery, move through Odyssey, or rest in
                    Sanctity. Or live all three in a single breath. Some come
                    for stillness. Some to create. Some to heal.
                  </p>

                  <p className="text-lg text-center">
                    Mos takes form — not just as an idea, but as something you
                    can use. A simple way to see where you are, and return to
                    what matters.
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <div className="flex justify-between mb-2">
                        ...
                        <div className="text-muted-foreground">
                          817 kcal{" "}
                          <span className="opacity-50">/ 500 kcal</span>
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between mb-2">
                        ...
                        <div className="text-muted-foreground">
                          815 kcal{" "}
                          <span className="opacity-50">/ 3000 kcal</span>
                        </div>
                      </div>
